...
## 0. Основа проєкту
- [ ] Створити структуру `fixly-crm/frontend`, `fixly-crm/backend`, `fixly-crm/docs`
- [ ] Ініціалізувати Git-репозиторій, перший commit
- [ ] Створити `.gitignore` (node_modules, .env, dist)
- [ ] Створити README.md-заглушку

## 1. PostgreSQL + Prisma
- [ ] Розібратись із базовими поняттями: table, row, primary key, foreign key, relation
- [ ] Встановити PostgreSQL локально (або через Docker)
- [ ] Ініціалізувати Prisma в `backend/`
